from hand_calculation.tile_constants import ONE_MAN, TWO_MAN, THREE_MAN, \
    ...
    SEVEN_SOU, EIGHT_SOU, NINE_SOU, EAST, SOUTH, WEST, NORTH, HAKU, HATSU, \
    CHUN, RED_FIVE_MAN, RED_FIVE_PIN, RED_FIVE_SOU
...
SELF_WIND_SIZE = 1
TOTAL_COLUMNS_SIZE = 364
TOTAL_FEATURES_COUNT = 12376
