...
from hand_calculation.tile_constants import NORTH
from hand_calculation.yaku import Yaku


class North(Yaku):
    """
    Pon/kan of north in player's seat wind or in the prevalent wind.
    """
